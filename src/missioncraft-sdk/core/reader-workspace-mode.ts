...
// applyReaderRefUpdate helper DELETED at v1.2.0 W7-new slice (iv) — coord-mirror semantic was
// dropped at W4-new slice v.b (v5.0 reader uses direct fetch+reset from source-remote via
// readerLoopBV5Tick); helper had no production callers.
